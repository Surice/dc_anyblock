...
exports.checkResponse = exports.verification = void 0;
var discord_js_1 = require("discord.js");
var __1 = require("..");
function verification(channel, content) {
...
function checkResponse(inMessage, message) {
    return __awaiter(this, void 0, void 0, function () {
        var answer;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, inMessage.channel.send(message)];
                                case 1:
                                    _a.sent();
                                    checkFunction = function (answerMsg) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            if (answerMsg.channel.id != inMessage.channel.id)
                                                return [2 /*return*/];
                                            if (answerMsg.author.id != inMessage.author.id)
                                                return [2 /*return*/];
                                            resolve(answerMsg.content);
                                            __1.client.removeListener("messageCreate", checkFunction);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    __1.client.addListener("messageCreate", checkFunction);
                                    setTimeout(function () {
                                        __1.client.removeListener("messageCreate", checkFunction);
                                        resolve(undefined);
                                    }, 60000);
